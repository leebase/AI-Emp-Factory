...
|---|---|---|---|
| `router` | `/home/lee/projects/lee-llm-router` | `0924d63cd8efbbb8cb40b557cb35872f47ea949f` | 59 |
...
Built 2026-09-17T18:12:02Z by `scripts/build_distribution.sh` from `scripts/manifest.distribution.json` (components: revision).
